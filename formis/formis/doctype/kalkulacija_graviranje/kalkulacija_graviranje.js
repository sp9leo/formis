...
frappe.ui.form.on('Kalkulacija graviranje', {
	refresh: function(frm) {

	}
});
frappe.ui.form.on("Kalkulacija graviranje", "len", function(frm) {
cur_frm.set_value("area", (frm.doc.len* frm.doc.wid));
 });
 
 frappe.ui.form.on("Kalkulacija graviranje", "wid", function(frm) {
 cur_frm.set_value("area", (frm.doc.len* frm.doc.wid))       
 });
 
 //izracunaj povrsino//
 frappe.ui.form.on("Kalkulacija graviranje", "area", function(frm) {
 ...
 frappe.ui.form.on("Kalkulacija graviranje", "refresh", function(frm) {
...
cur_frm.set_value("valueovermin",d);
 ...
 frappe.ui.form.on("Kalkulacija graviranje", "qty", function(frm) {
 var qty= frm.doc.qty;   
